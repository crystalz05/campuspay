...
class PaymentResultScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final state = context.read<FeePaymentBloc>().state;
    final transaction = state is FeePaymentSuccess ? state.transaction : null;
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(
                isSuccess
                    ? 'Your school fee has been paid and recorded.'
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      _ResultRow(
                        label: 'Description',
                        value: transaction.description ?? 'School Fee Payment',
                      ),
                      Divider(height: 1, color: theme.dividerColor),
                      _ResultRow(
                        label: 'Date & Time',
